...
$product_query = $db->dbCon->query($sql);

$product_details = $product_query->fetch_assoc();
...
<section id="product" class="py-3">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <img src="<?php echo $product_details['item_image'];?>" alt="product" class="img-fluid">
            ...
            <div class="col-sm-6 py-5">
                <h5 class="font-baloo font-size-20"><?php echo $product_details['item_name'];?></h5>
                <small>by <?php echo $product_details['item_brand'];?></small>
                <div class="d-flex">
                ...
                <!---    product price       -->
                    <table class="my-3">
                        ...
                        <tr class="font-rale font-size-14">
                            <td>Deal Price:</td>
                            <td class="font-size-20 text-danger">$<span><?php echo $product_details['item_price']?></span><small class="text-dark font-size-12">&nbsp;&nbsp;Inclusive of all taxes</small></td>
                        </tr>
                        <tr class="font-rale font-size-14">
                            <td>You Save:</td>
...
<!-- Top Sale -->
<?php require_once('template/top_sales.php');?>
<!-- !Top Sale -->
